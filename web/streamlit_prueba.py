...
if st.button('Buscar experiencia'):
    ...
    if response.status_code == 200:
        ...
        for item in filtered_name:
            st.write(f"Nombre: {item['name']}, Tipo: {item['type']}, Descripción: {item['description']}")
...
review_modal(1)  # Deberías llamar a esta función con el ID de la experiencia correspondiente al botón presionado